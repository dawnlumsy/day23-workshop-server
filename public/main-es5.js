(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MenuComponent = /** @class */ (function () {
                function MenuComponent(fb, router) {
                    this.fb = fb;
                    this.router = router;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OrderComponent = /** @class */ (function () {
                function OrderComponent(fb, ordSvc) {
                    this.fb = fb;
                    this.ordSvc = ordSvc;
                }
                ...
                OrderComponent.prototype.checkout = function () {
                    ...
                    for (var g = 0; g < this.orderDetails.length; g++) {
                        var fg = this.orderDetails.controls[g];
                    ...
                    this.ordSvc.createOrder(order)
                        ...
                        _this.orderDetails = _this.fb.array([]);
                        _this.orderForm.controls['orderDetails'] = _this.orderDetails;
                        _this.orderForm.reset();
                    })
                        .catch(function (err) { return console.error('error: ', err); });
                };
                OrderComponent.prototype.addOrderDetails = function () {
                ...
                OrderComponent.prototype.createOrderDetails = function () {
                ...
                OrderComponent.prototype.removeOrderDetails = function (idx) {
                    console.info("the line is: ", idx);
                    this.orderDetails.removeAt(idx);
                };
                OrderComponent.prototype.createFrom = function (od) {
                    if (od === void 0) { od = null; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateComponent = /** @class */ (function () {
                function UpdateComponent(ordSvc, fb, activatedRoute) {
                    this.ordSvc = ordSvc;
                    this.fb = fb;
                ...
                UpdateComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var ordId = this.activatedRoute.snapshot.params.ordId;
                    this.ordSvc.getOrder(ordId)
                        .then(function (result) {
                        _this.order = result;
                        //console.info("All orders: ", this.order);
                        _this.form = _this.createFrom(result);
                        _this.orderDetails = _this.form.get('orderDetails');
                    })
                        .catch(function (error) {
                        console.info("error: ", error);
                    });
                };
                UpdateComponent.prototype.addOrderDetails = function () {
                    console.info('before:', this.orderDetails.length);
                    this.orderDetails.push(this.createOrderDetailsEmpty());
                    console.info('after:', this.orderDetails.length);
                };
                UpdateComponent.prototype.removeOrderDetails = function (idx) {
                    console.info("the line is: ", idx);
                    this.orderDetails.removeAt(idx);
                };
                UpdateComponent.prototype.updateOrder = function () {
                    var _this = this;
                    ...
                    this.ordSvc.updateOrderDetails(order.ord_id.toString(), order)
                        ...
                        _this.orderDetails = _this.fb.array([]);
                        _this.form.controls['orderDetails'] = _this.orderDetails;
                        _this.form.reset();
                    })
                        .catch(function (err) { return console.error('error: ', err); });
                };
                UpdateComponent.prototype.createOrderDetailsEmpty = function () {
                    return (this.fb.group({
                        description: this.fb.control('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
                        quantity: this.fb.control('1', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(1)])
                    }));
                };
                UpdateComponent.prototype.createOrderDetails = function (od) {
                    return (this.fb.group({
                ...
                UpdateComponent.prototype.createFrom = function (order) {
                    var ordDetails = this.fb.array([]);
                    for (var _i = 0, _a = order.orderDetails; _i < _a.length; _i++) {
                        var od = _a[_i];
                        ordDetails.push(this.createOrderDetails(od));
                    }
                    var ordForm = this.fb.group({
                        ord_id: order.ord_id,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OrderserviceService = /** @class */ (function () {
                function OrderserviceService(httpClient) {
                    this.httpClient = httpClient;
                }
                OrderserviceService.prototype.createOrder = function (order) {
                    return (this.httpClient.post('/api/order', order).toPromise());
                };
                OrderserviceService.prototype.getOrder = function (ordId) {
                    console.info("enter getOrder Service: ", ordId);
                    return (this.httpClient.get('/api/order/' + ordId).toPromise());
                };
                OrderserviceService.prototype.updateOrderDetails = function (ordId, order) {
            ...
            OrderserviceService.ctorParameters = function () { return [
